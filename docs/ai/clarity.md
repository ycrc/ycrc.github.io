...
The YCRC recommends using locallized open-source models on the Cluster or Clarity for research purposes due to data exposure risks (See Below).
...
For API keys, however, there is significant more risk:
