...
`ycrc_conda_env.list` has been replaced by `ycrc_conda_env.sh`. To update your conda environments in OOD for the Jupyter App and RStudio Desktop (with Conda R), please run `ycrc_conda_env.sh update`.
