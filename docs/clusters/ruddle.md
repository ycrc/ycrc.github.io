...
!!! info "Upcoming Ruddle Retirement"
    After more than seven years in service, we will be retiring the Ruddle HPC cluster on July 24th. Ruddle is being replaced with the new HPC cluster, [McCleary](/clusters/mccleary). For more information and updates see the [McCleary announcement page](/clusters/mccleary-farnam-ruddle).
