...
!!! info "Upcoming Farnam Retirement"
    After more than six years in service, we will be retiring the Farnam HPC cluster in mid 2023. Farnam will be replaced with a new HPC cluster, McCleary. For more information and updates see the [McCleary announcement page](/clusters/farnam-decommission).
