...
=== "gpu"
    ...
    **Available Compute Nodes**
    ...
    |3|E5-2660_v3|20|119|k80|4|12|haswell, E5-2660_v3, doubleprecision, common, oldest, k80|
...
=== "scavenge"
    ...
    **Available Compute Nodes**
    ...
    |Count|CPU Type|CPUs/Node|Memory/Node (GiB)|GPU Type|GPUs/Node|vRAM/GPU (GB)|Node Features|
    |---|---|---|---|---|---|---|---|
    |111|8268|48|356||||cascadelake, avx512, 8268, nogpu, standard, common, bigtmp|
    |12|6240|36|1505||||cascadelake, avx512, 6240, nogpu, standard, common, bigtmp|
    |8|6240|36|370||||cascadelake, avx512, 6240, nogpu, pi, bigtmp|
    |7|6240|36|181|rtx2080ti|4|11|cascadelake, avx512, 6240, singleprecision, common, bigtmp, rtx2080ti|
    |4|6240|36|370|v100|4|16|cascadelake, avx512, 6240, doubleprecision, common, v100|
    |2|6240|36|180|rtx3090|4|24|cascadelake, avx512, 6240, doubleprecision, bigtmp, pi, rtx3090|
    |2|6240|36|361|a100|4|40|cascadelake, avx512, 6240, doubleprecision, bigtmp, common, a100|
    |241|6142|32|181||||skylake, avx512, 6142, nogpu, standard, pi, bigtmp|
    |164|6136|24|90||||edr, skylake, avx512, 6136, nogpu, standard, pi, bigtmp|
    ...
    |2|6136|24|90|v100|2|16|skylake, avx512, 6136, doubleprecision, common, bigtmp, v100|
    |179|E5-2660_v4|28|245||||broadwell, E5-2660_v4, nogpu, standard, common|
    |7|E5-2660_v4|28|245|p100|1|16|broadwell, E5-2660_v4, doubleprecision, common, p100|
    |1|E5-2637_v4|8|119|gtx1080ti|4|11|broadwell, E5-2637_v4, singleprecision, pi, bigtmp, gtx1080ti|
    |80|E5-2660_v3|20|119||||haswell, E5-2660_v3, nogpu, standard, common, oldest|
...
=== "scavenge_gpu"
    ...
    **Available Compute Nodes**
    ...
    |---|---|---|---|---|---|---|---|
    |4|6240|36|370|v100|4|16|cascadelake, avx512, 6240, doubleprecision, common, v100|
    |6|6240|36|181|rtx2080ti|4|11|cascadelake, avx512, 6240, singleprecision, common, bigtmp, rtx2080ti|
    |2|6240|36|180|rtx3090|4|24|cascadelake, avx512, 6240, doubleprecision, bigtmp, pi, rtx3090|
    |2|6240|36|361|a100|4|40|cascadelake, avx512, 6240, doubleprecision, bigtmp, common, a100|
    |2|5122|8|181|rtx2080|4|8|skylake, avx512, 5122, singleprecision, pi, rtx2080|
    |9|6136|24|181|p100|4|16|skylake, avx512, 6136, doubleprecision, pi, p100|
