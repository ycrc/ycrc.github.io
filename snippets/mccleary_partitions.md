=== "day"
    ...
    **Available Compute Nodes**
    ...
    |---|---|---|---|---|
    |30|8358|64|983|icelake, avx512, 8358, nogpu, bigtmp, common|
    |15|6240|36|180|cascadelake, avx512, 6240, nogpu, bigtmp, standard, common|
...
=== "week"
    ...
    **Available Compute Nodes**
    ...
    |Count|CPU Type|CPUs/Node|Memory/Node (GiB)|Node Features|
    |---|---|---|---|---|
    |10|8358|64|983|icelake, avx512, 8358, nogpu, bigtmp, common|
...
=== "gpu"
    ...
    **Available Compute Nodes**
    ...
    |---|---|---|---|---|---|---|---|
    |14|6326|32|206|a5000|4|24|icelake, avx512, 6326, doubleprecision, a5000|
    |1|8358|64|983|a100|4|40|icelake, avx512, 8358, doubleprecision, bigtmp, common, a100-80g|
    ...
    |2|5222|8|163|rtx5000|4|16|cascadelake, avx512, 5222, doubleprecision, pi, bigtmp, rtx5000|
    |10|E5-2637_v4|8|101|gtx1080ti|4|11|broadwell, E5-2637_v4, singleprecision, oldest, common, gtx1080ti|
...
=== "scavenge"
    ...
    **Available Compute Nodes**
    ...
    |20|6326|32|206|a5000|4|24|icelake, avx512, 6326, doubleprecision, a5000|
    ...
    |4|5222|8|163|rtx5000|4|16|cascadelake, avx512, 5222, doubleprecision, common, bigtmp, rtx5000|
    |10|5222|8|163|rtx5000|4|16|cascadelake, avx512, 5222, doubleprecision, pi, bigtmp, rtx5000|
...
??? summary "PI Partitions (click to expand)"
    ...
    === "pi_cryoem"
        ...
        **Available Compute Nodes**
        ...
        |Count|CPU Type|CPUs/Node|Memory/Node (GiB)|GPU Type|GPUs/Node|vRAM/GPU (GB)|Node Features|
        |---|---|---|---|---|---|---|---|
        |6|6326|32|206|a5000|4|24|icelake, avx512, 6326, doubleprecision, a5000|
